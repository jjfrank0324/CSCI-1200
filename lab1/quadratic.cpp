...
int main() {
	...
	std::cerr << "OUT PUT IS HERE" << std::endl;
...
//    c_array[i] = my_CC;
//    int Smaller_root;
//    find_roots(1,my_BB,my_CC, root_1,root_2);
//	if (root_1<root_2)
//	{
//		smaller_root[i] = my_BB;
//	}
//	if (root_1>=root_2)
//	{
//		smaller_root[i] = my_CC;
//	}
//  }
//  for (int j=0;j<5;j++)
//  {
//	  std::cout << "The roots are: " << smaller_root[j] <<  std::endl;
//  }
//  return 0;
}
