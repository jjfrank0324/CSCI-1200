...
//Reading tips,the main recursing function is at line 609
...
void find_solutions(vector<vector<vector<string> > > &solutions,
    ...
    , int direction_indicator, string order)
    {
      if(all_ship[0] == "unkown")
      {
        string SHIPNAME [7] = {"tanker", "cargo", "carrier", "battleship", "crusier", "destroyer", "submarine"};
        for(unsigned int i =0; i<7; i++)
        {
          all_ship[0] = SHIPNAME[i];
          cout<<all_ship[0] ;
          find_solutions(solutions, board, row_ship, col_ship, all_ship, ID, temp_sol, all_sol, marking,-1, order);
      ...
      //&& (all_sol.size()==0 || order!= "find_all_solutions")
      ...
      //
      //         find_solutions(solutions, board, row_ship, col_ship, all_ship, ID, temp_sol, all_sol, marking,0, order);
      //       }
      //
      //     }
      //   }
      // }
      //below is the normal case, which we know the name of the ship
       // else
       // {
...
//               , ID, temp_sol, all_sol, marking, direction_indicator, order );
